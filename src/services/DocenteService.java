...
public class DocenteService {
    ...
    public void registrarPlanoAtividades(Oportunidade oportunidade){
        if (oportunidade.getStatusOportunidade() == StatusOportunidade.EM_PROGRESSO){
            //PlanoAtividades.add(oportunidade);    <- meu sonho
